...
import static djf.components.AppStyleComponent.CLASS_FILE_BUTTON_ABOUT;
...
public class AppGUI {
    ...
    protected HBox appPaneTop;
    
    // THIS IS THE TOP TOOLBAR AND ITS CONTROLS
    protected FlowPane fileToolbarPane;
    protected FlowPane fileToolbarPane2;
    ...
    public void updateExportToolbar(boolean exportSelected){
        if(exportSelected){
            exportButton.setDisable(false);
        }
        else{
    ...
    private void initFileToolbar(AppTemplate app) {
        ...
        fileToolbarPane.setPrefWrapLength(10000);
        fileToolbarPane2 = new FlowPane();
        fileToolbarPane2.setPrefWrapLength(10000);
...
//        primaryStage.setWidth(bounds.getWidth());
        ...
        appPaneTop = new HBox();
        appPaneTop.getChildren().addAll(fileToolbarPane, fileToolbarPane2);
        appPane.setTop(appPaneTop);
	...
	fileToolbarPane.getStyleClass().add(CLASS_BORDERED_PANE);
        fileToolbarPane2.getStyleClass().add(CLASS_BORDERED_PANE);
	...
	exitButton.getStyleClass().add(CLASS_FILE_BUTTON);
        ...
        aboutButton.getStyleClass().add(CLASS_FILE_BUTTON_ABOUT);
    }
}
