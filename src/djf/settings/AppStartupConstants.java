...
public class AppStartupConstants
{
    ...
    public static final String APP_PROPERTIES_FILE_NAME = "app_properties.xml"; //the name of the xml file to load
    ...
    public static final String PROPERTIES_SCHEMA_FILE_NAME = "properties_schema.xsd";  //the name of the xml file to load  

    // PROTOCOLS AND PATHS NEEDED FOR LOADING CERTAIN FILES
    public static final String FILE_PROTOCOL = "file:";
    public static final String PATH_DATA = "./data/"; //paths and directories for certain files.
